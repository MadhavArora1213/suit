...
export default function HowItWorks() {
  return (
    <section className="py-12 md:py-20 bg-white relative overflow-hidden z-10 -mt-10">
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6 relative z-10">
        ...
        <motion.p 
          ...
          className="text-center text-[13px] sm:text-[15px] text-[#555] max-w-[600px] mx-auto mb-3 leading-relaxed"
        ...
        <motion.p 
          ...
          className="text-center text-[13px] sm:text-[14px] text-[#888] mb-10 sm:mb-16"
          style={{ fontFamily: "'DM Sans', sans-serif" }}
        >
          Every time a special occasion comes, the chaos begins...
        </motion.p>

        {/* Chaos Area - Desktop only */}
        <div className="hidden md:block relative h-[500px] mb-16">
          
          {/* Center - Confused Character */}
          ...
          {/* Left Side Elements */}
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="absolute top-[80px] left-[2%] z-20" style={{ transform: 'rotate(-4deg)' }}>
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.22 }} className="absolute top-[115px] left-[5%] z-20" style={{ transform: 'rotate(-2deg)' }}>
            <div className="bg-white px-3 py-1.5 rounded shadow-md border border-gray-100">
              <span className="text-[10px] text-gray-500 font-mono">Size_guide_?.pdf</span>
            </div>
          </motion.div>

          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.24 }} className="absolute top-[150px] left-[1%] z-20" style={{ transform: 'rotate(-6deg)' }}>
            <div className="bg-white px-3 py-1.5 rounded shadow-md border border-gray-100">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.35 }} className="absolute top-[140px] right-[2%] z-20">
            <div className="w-[130px] h-[150px]">
              <img src="/Images/Frustrated.png" alt="Gurnaaz frustrated" className="w-full h-full object-contain" style={{ filter: 'drop-shadow(0 8px 16px rgba(0,0,0,0.1))' }} />
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.34 }} className="absolute bottom-[45px] right-[8%] z-20" style={{ transform: 'rotate(-1deg)' }}>
            <div className="bg-white px-3 py-1.5 rounded shadow-md border border-gray-100">
              <span className="text-[10px] text-gray-500 font-mono">Delivery_v2_FINAL.xlsx</span>
            </div>
          </motion.div>

          <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.4, type: 'spring' }} className="absolute top-[280px] right-[3%] z-20">
          ...
          {/* Emojis */}
          <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.2, type: 'spring' }} className="absolute top-[110px] left-[22%] text-2xl z-10">😫</motion.div>
          <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.3, type: 'spring' }} className="absolute top-[80px] right-[22%] text-2xl z-10">🧐</motion.div>
          <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.35, type: 'spring' }} className="absolute bottom-[100px] right-[22%] text-2xl z-10">😩</motion.div>
          <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.4, type: 'spring' }} className="absolute bottom-[80px] left-[28%] text-2xl z-10">💸</motion.div>

          {/* Notification Badges */}
          <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.25, type: 'spring' }} className="absolute top-[170px] left-[25%] bg-red-500 text-white text-[10px] font-bold w-7 h-7 rounded-full flex items-center justify-center shadow-lg z-40">132</motion.div>
          <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.4, type: 'spring' }} className="absolute top-[200px] right-[18%] bg-red-500 text-white text-[10px] font-bold w-7 h-7 rounded-full flex items-center justify-center shadow-lg z-40">42</motion.div>
          <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.45, type: 'spring' }} className="absolute bottom-[120px] right-[25%] bg-red-500 text-white text-[10px] font-bold w-7 h-7 rounded-full flex items-center justify-center shadow-lg z-40">87</motion.div>
        </div>

        {/* Mobile Chaos - Simplified */}
          ...
          <div className="flex justify-center mb-6">
            <motion.div initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              <div className="w-[180px] h-[220px]">
                <img src="/Images/Confused.png" alt="Gurnaaz confused" className="w-full h-full object-contain" style={{ filter: 'drop-shadow(0 15px 30px rgba(0,0,0,0.12))' }} />
              </div>
            </motion.div>
          </div>
        ...
        >
          <div className="relative w-full max-w-[300px] md:max-w-[400px] aspect-[400/280]">
        ...
        >
          <div className="w-[120px] sm:w-[160px] h-[140px] sm:h-[180px] relative">
            <img
