        ...
        <AnimatePresence mode="wait">
          ...
          >
            {filteredCollections.map((collection, index) => (
              ...
              >
                {/* Card */}
                <div className="relative aspect-[3/4] overflow-hidden bg-[#E8DDD0]">
                  <img
                  ...
                  {/* Multi-layer overlay */}
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-black/5 transition-opacity duration-500" />
                  ...
                  <div className="absolute top-4 left-4 z-10">
                    <span
                      className="bg-black/40 backdrop-blur-md text-[8px] font-bold tracking-[0.2em] uppercase px-3 py-1.5 border border-white/10"
                      style={{ color: collection.accent, fontFamily: "'Montserrat', sans-serif" }}
                    >
                      {collection.tag}
                    </span>
                  </div>

                  {/* Edit number watermark */}
                  <div className="absolute top-4 right-4 z-10">
                    <span
                      className="text-white/15 text-[40px] md:text-[50px] font-light leading-none"
                      style={{ fontFamily: "'Cormorant Garamond', serif" }}
                    >
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-7 z-10">
                    {/* Title */}
                    <h3
                      className="text-2xl md:text-3xl font-light text-white leading-tight mb-1 tracking-wide"
                      style={{ fontFamily: "'Cormorant Garamond', serif" }}
                    >
                      {collection.title}{' '}
                      <span className="italic" style={{ color: collection.accent }}>
                        {collection.subtitle}
                      </span>
                    </h3>
                    ...
                    {/* Description */}
                    <p
                      className="text-white/60 text-xs leading-relaxed mb-5 line-clamp-2 max-w-[250px]"
                      style={{ fontFamily: "'DM Sans', sans-serif" }}
                    >
                      {collection.desc}
                    </p>
                    ...
                    <div className="flex items-center justify-between">
                      <span
                        className="text-[10px] font-bold tracking-[0.15em] uppercase flex items-center gap-2 transition-all duration-300"
                        style={{ color: collection.accent, fontFamily: "'Montserrat', sans-serif" }}
                      >
                        Explore
                      ...
                      {collection.category !== 'All' && (
                        <span className="text-[9px] text-white/30 tracking-wider" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                          {getProductCount(collection.category)} pieces
                        </span>
                      )}
                    </div>
                  </div>
