    ...
    <section className="relative w-full bg-[#FAF9F6] py-32 overflow-hidden" id="fabric-zoom">
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 flex flex-col lg:flex-row gap-16 items-center">
        ...
        <div className="w-full lg:w-1/3 text-left">
          ...
          <h2 className="text-6xl md:text-8xl lg:text-9xl font-light text-[#1A0008] leading-[0.9] tracking-tight mb-10" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            Feel the <br/>
            <em className="italic text-[#D4AF37] font-light">Texture</em>
          </h2>
          <p className="text-[#555] text-[13px] tracking-wide leading-relaxed font-light mb-12" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="w-full lg:w-2/3">
          ...
          >
            ...
            {isHovered && (
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-30">
                  <div className="w-6 h-[1px] bg-[#1A0008]/40"></div>
                  <div className="h-6 w-[1px] bg-[#1A0008]/40 absolute"></div>
                </div>
              </motion.div>
            )}
            ...
            {!isHovered && (
              ...
              >
                <span className="bg-white/80 backdrop-blur-md text-[#1A0008] border border-[#1A0008]/5 px-8 py-4 rounded-full text-[10px] tracking-[0.4em] font-medium uppercase shadow-lg flex items-center gap-4">
