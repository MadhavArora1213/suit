...
export default function CategoryShowcase() {
  return (
    <section className="py-28 bg-[#1A0008]" id="collections">
      <div className="max-w-[1600px] mx-auto px-6 md:px-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-2">
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}
              ...
              <h2 className="text-4xl md:text-5xl font-light text-[#E8DDD0] leading-tight"
                ...
                Explore <em className="italic text-[#D4AF37]">Our Collections</em>
              </h2>
              <div className="mt-4 w-12 h-px bg-[#D4AF37]/40" />
            </motion.div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-5 md:gap-7">
              {categories.map((cat, index) => (
                <motion.div key={index}
                  ...
                  <div className="aspect-square overflow-hidden relative bg-[#1E1E1E] mb-3 border border-[#D4AF37]/10 group-hover:border-[#D4AF37]/40 transition-all duration-400">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#E8DDD0]/70 to-transparent p-3 translate-y-full group-hover:translate-y-0 transition-transform duration-400">
                      <span className="text-[9px] tracking-[0.2em] text-[#D4AF37] uppercase font-semibold flex items-center gap-1.5"
                        style={{ fontFamily: "'DM Sans', sans-serif" }}>
                        Shop Now <ArrowRight size={10} />
                      </span>
                    </div>
                  </div>
                  <span className="text-[13px] font-medium tracking-wide text-[#E8DDD0] group-hover:text-[#D4AF37] transition-colors duration-300 block text-center"
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="absolute inset-3 border border-[#D4AF37]/15 z-20 pointer-events-none" />

            <div className="relative z-30">
              <span className="text-[9px] font-semibold tracking-[0.28em] text-[#D4AF37] uppercase block mb-3"
                style={{ fontFamily: "'DM Sans', sans-serif" }}>
                Boutiques You Can Trust
              </span>
              <h3 className="text-2xl md:text-3xl font-light text-[#1A0008] mb-4 leading-snug"
                style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                Curated Stores from<br /><em className="italic text-[#D4AF37]">Across India</em>
              </h3>
              <p className="text-xs text-[#1A0008]/55 mb-8 leading-relaxed"
                style={{ fontFamily: "'DM Sans', sans-serif" }}>
                Explore handpicked designer suits directly sourced from verified heritage boutiques and master artisans.
              </p>
              <motion.button whileHover={{ scale: 1.02, backgroundColor: '#D4AF37', color: '#FAF9F6', borderColor: '#D4AF37' }}
                whileTap={{ scale: 0.98 }}
                className="w-full border border-[#1A0008]/30 text-[#1A0008] py-3.5 text-[9px] font-semibold tracking-[0.25em] inline-flex items-center justify-center gap-2 transition-all duration-300 cursor-pointer"
                style={{ fontFamily: "'DM Sans', sans-serif" }}>
