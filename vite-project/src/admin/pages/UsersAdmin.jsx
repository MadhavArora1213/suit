    ...
    <div className="min-h-screen bg-[#F6F3F8] font-sans pb-20">
      <div className="max-w-[1200px] mx-auto px-4 md:px-8 py-8 md:py-12">
        ...
        <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <h1 className="text-3xl md:text-4xl font-light text-[#111111] mb-2 tracking-tight" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              Login Users
            </h1>
            <p className="text-sm text-[#111111]/50">Manage registered users and accounts</p>
          </div>
          <div className="relative">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-[#111111]/40" size={18} />
            <input
              type="text"
              placeholder="Search users..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="pl-10 pr-4 py-2.5 bg-white border border-[#111111]/10 rounded-xl focus:border-[#BCA58A] focus:ring-1 focus:ring-[#BCA58A] outline-none w-full md:w-[300px] text-sm text-[#111111] transition-all"
            />
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl p-12 text-center border border-[#111111]/5 shadow-sm">
            <Users className="w-12 h-12 text-[#111111]/20 mx-auto mb-4" />
            <h3 className="text-lg font-medium text-[#111111] mb-2">No users found</h3>
            <p className="text-sm text-[#111111]/50">There are no customers matching your search criteria.</p>
          </div>
        ) : (
