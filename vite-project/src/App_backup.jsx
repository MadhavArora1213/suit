...
function App() {
  ...
  useEffect(() => {
    ...
    const handlePopState = () => {
      ...
      } else if (newView === 'product-details') {
        const prod = getProductFromPath();
        if (prod) setSelectedProduct(prod);
      } else if (newView === 'boutiques' || newView === 'seller-shop') {
        const bot = getBoutiqueFromPath();
        if (bot) setSelectedBoutique(bot);
      } else if (newView === 'collection-detail') {
        const col = getCollectionFromPath();
        if (col) setSelectedCollectionSlug(col);
      }
    };
