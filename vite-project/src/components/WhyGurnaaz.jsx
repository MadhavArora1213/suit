      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-[40px] md:text-[60px] text-[#1A0008] font-light leading-tight tracking-tighter" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            Why <span className="italic text-[#D4AF37]">Gurnaaz?</span>
          </h2>
        </div>
        ...
        <div className="relative w-full h-[1800px] md:h-[900px] flex flex-col md:flex-row gap-4 md:gap-6">
          ...
          <div className="flex-1 flex flex-col gap-4 md:gap-6 h-full">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="h-[350px] md:h-[50%] bg-[#1A0008] rounded-[32px] p-8 md:p-10 relative overflow-hidden shadow-lg flex flex-col justify-end"
            >
              <div className="relative z-20">
                <span className="text-[#D4AF37] text-[10px] uppercase tracking-widest font-bold block mb-3">01 / Heritage</span>
            ...
            <motion.div 
              ...
              className="h-[250px] md:h-[30%] bg-[#D4AF37] rounded-[32px] overflow-hidden shadow-lg relative p-8 flex flex-col justify-end"
            >
            ...
            <motion.div 
              ...
              className="h-[150px] md:h-[20%] bg-white border border-[#D4AF37]/20 rounded-[32px] overflow-hidden shadow-sm p-6 flex flex-col justify-center"
            >
               <div className="relative z-10">
                  <span className="text-[#D4AF37] text-[10px] uppercase tracking-widest font-bold block mb-1">03 / Stitching</span>
          ...
          <div className="flex-[2_2_0%] flex flex-col gap-4 md:gap-6 h-full">
            ...
            <motion.div 
              ...
              className="h-[400px] md:h-[40%] bg-white border border-[#D4AF37]/10 rounded-[40px] p-6 pb-20 md:p-8 md:pb-24 flex items-center shadow-sm relative overflow-hidden group"
            >
              ...
              <div className="w-1/2 pl-6 md:pl-10 relative z-10 pb-8">
                <span className="text-[#D4AF37] px-3 py-1 bg-[#D4AF37]/10 rounded-full text-[10px] uppercase tracking-widest font-bold inline-block mb-4">04 / Craftsmanship</span>
            ...
            <div className="h-[500px] md:h-[60%] flex flex-col md:flex-row gap-4 md:gap-6">
              ...
              <motion.div 
                ...
                className="flex-1 bg-[#D4AF37] rounded-[40px] p-8 pt-20 md:p-10 md:pt-32 md:pr-16 flex flex-col shadow-xl relative overflow-hidden"
              >
                <div className="relative z-10">
              ...
              <motion.div 
                ...
                className="flex-1 bg-[#1A0008] rounded-[40px] p-8 md:p-10 flex flex-col justify-end items-end text-right shadow-xl relative overflow-hidden"
              >
                ...
                <div className="relative z-10 pl-12 md:pl-20 mt-auto">
                  <span className="text-[#D4AF37] text-[10px] uppercase tracking-widest font-bold block mb-2">06 / Presentation</span>
                ...
                {/* Brand Logos (Mockup) */}
                <div className="flex gap-6 items-center opacity-40 mix-blend-screen relative z-10 text-[#D4AF37]">
          ...
          <div className="flex-1 flex flex-col gap-4 md:gap-6 h-full">
            ...
            >
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <span className="text-[#D4AF37] text-[10px] uppercase tracking-widest font-bold block mb-2">07 / Design</span>
            ...
            <motion.div 
              ...
              className="h-[250px] md:h-[30%] bg-white border border-[#D4AF37]/30 rounded-[32px] overflow-hidden shadow-sm p-8 flex flex-col justify-center"
            >
              <div className="relative z-10">
                <span className="text-[#D4AF37] text-[10px] uppercase tracking-widest font-bold block mb-2">08 / Values</span>
            ...
            <motion.div 
              ...
              className="h-[150px] md:h-[20%] bg-[#1A0008] rounded-[32px] shadow-lg p-6 flex flex-col justify-center"
            >
              <span className="text-[#D4AF37] text-[10px] uppercase tracking-widest font-bold block mb-1">09 / Convenience</span>
