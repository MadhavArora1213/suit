    ...
    <div className="min-h-screen bg-[#FAF9F6] pt-32 pb-20 px-6">
      <div className="max-w-[600px] mx-auto">
        ...
        <button
          ...
          className="flex items-center gap-2 text-[#1A0008]/40 hover:text-[#D4AF37] transition-colors cursor-pointer mb-12 group"
        >
        ...
        <motion.div
          ...
          className="bg-white rounded-3xl p-8 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#1A0008]/5 relative overflow-hidden"
        >
          ...
          <div className="space-y-6 mb-12">
            <div className="flex items-center p-4 rounded-xl bg-[#FAF9F6] border border-[#1A0008]/5">
            ...
            {user.phone && (
              <div className="flex items-center p-4 rounded-xl bg-[#FAF9F6] border border-[#1A0008]/5">
                ...
                <div>
                  <div className="text-[10px] text-[#1A0008]/40 uppercase tracking-wider font-semibold mb-1">Phone Number</div>
                  <div className="text-sm text-[#1A0008]">{user.phone}</div>
                </div>
              </div>
            )}

            <div className="flex items-center p-4 rounded-xl bg-[#FAF9F6] border border-[#1A0008]/5">
              <Calendar className="w-5 h-5 text-[#D4AF37] mr-4" />
              <div>
                <div className="text-[10px] text-[#1A0008]/40 uppercase tracking-wider font-semibold mb-1">Member Since</div>
                <div className="text-sm text-[#1A0008]">{joinDate}</div>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-4 border-2 border-[#1A0008]/10 text-[#1A0008]/60 rounded-xl flex items-center justify-center gap-2 hover:border-[#1A0008] hover:text-[#1A0008] hover:bg-[#1A0008]/5 transition-all duration-300 font-medium text-sm cursor-pointer"
          >
            <LogOut size={16} />
            Log Out Securely
          </button>
