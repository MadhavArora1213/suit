...
export const staticProducts = [
  ...
  // ── Badshah Designer Fabrics Products ──────────────────────────
  {
    id: 'ms1',
    name: 'Royal Punjabi Patiala Suit Set',
    price: '₹3,799',
    priceNum: 3799,
    boutique: 'Badshah Designer Fabrics',
    badge: 'Best Seller',
    collection: 'Best Sellers',
    type: 'Patiala',
    suitType: 'Patiala',
    ...
    additionalImages: ['https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&w=600&q=80', 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&w=600&q=80'],
    shortDesc: 'Classic Punjabi Patiala suit with rich silk top and heavily pleated salwar. Perfect for festive occasions and wedding celebrations.',
    fabricDetails: 'Premium art silk kurta with heavy thread work and mirror embellishments. Patiala salwar in matching silk with gold gotta lace borders.',
    fabricName: 'Art Silk',
    fabricDesc: 'Rich sheen with traditional Punjabi craftsmanship.',
    rating: 4.8
  },
  {
    id: 'ms2',
    name: 'Punjabi Chanderi Anarkali Suit',
    price: '₹5,499',
    priceNum: 5499,
    boutique: 'Badshah Designer Fabrics',
    badge: 'Premium',
    ...
    additionalImages: ['https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?auto=format&fit=crop&w=600&q=80', 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&w=600&q=80'],
    shortDesc: 'Elegant floor-length Anarkali in pure Chanderi silk with intricate hand embroidery and a flowing dupatta.',
    fabricDetails: 'Handloom Chanderi silk with traditional zardozi and thread work. Features a flattering flared silhouette with matching organza dupatta.',
    fabricName: 'Pure Chanderi Silk',
    fabricDesc: 'Lightweight luxury with heritage weave.',
    rating: 4.9
  },
  {
    id: 'ms3',
    ...
    additionalImages: ['https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?auto=format&fit=crop&w=600&q=80', 'https://images.unsplash.com/photo-1605784401368-5af1d9d6c4dc?auto=format&fit=crop&w=600&q=80'],
    shortDesc: 'Stunning Punjabi sharara suit with heavy gota patti work on the kurta and wide-leg sharara pants. A statement outfit for weddings.',
    fabricDetails: 'Pure georgette kurta with hand-applied gota patti and mirror work. Sharara in flowing rayon with gold borders. Includes matching organza dupatta.',
    fabricName: 'Pure Georgette',
    fabricDesc: 'Flowy elegance with royal gota embellishments.',
    rating: 4.7
  },
  {
    id: 'ms4',
    name: 'Ludhiana Silk Straight Suit',
    price: '₹4,299',
    priceNum: 4299,
    boutique: 'Badshah Designer Fabrics',
    badge: 'New Edition',
    ...
    additionalImages: ['https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?auto=format&fit=crop&w=600&q=80', 'https://images.unsplash.com/photo-1606800052052-a08af7148866?auto=format&fit=crop&w=600&q=80'],
    shortDesc: 'Contemporary straight-cut Pakistani suit in pure silk with delicate thread embroidery and a soft chiffon dupatta.',
    fabricDetails: 'Premium mulberry silk with precision thread embroidery. Straight pant in matching silk. Includes soft chiffon dupatta with gold border.',
    fabricName: 'Mulberry Silk',
    fabricDesc: 'Smooth, lustrous, and breathable.',
    rating: 4.6
  },
  {
    id: 'ms5',
    name: 'Banarasi Brocade Wedding Suit',
    price: '₹8,999',
    priceNum: 8999,
    boutique: 'Badshah Designer Fabrics',
    badge: 'Exclusive',
    ...
    care: ['Dry Clean Only'],
    sizes: ['S (36)', 'M (38)', 'L (40)', 'XL (42)'],
    image: 'https://images.unsplash.com/photo-1610694955371-d4a3e0ce4b52?auto=format&fit=crop&w=600&q=80',
    additionalImages: ['https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?auto=format&fit=crop&w=600&q=80', 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&w=600&q=80'],
    shortDesc: 'Opulent Banarasi brocade suit set with pure gold zari weaving. Designed for brides and wedding guests who appreciate heritage luxury.',
    fabricDetails: 'Handwoven Banarasi katan silk with intricate gold and silver zari brocade motifs. Includes matching silk salwar and heavy Banarasi dupatta.',
    fabricName: 'Banarasi Katan Silk',
    fabricDesc: 'Woven with pure gold and silver zari threads.',
    rating: 5.0
  },
  {
    id: 'ms6',
    name: 'Punjabi Chikankari Suit Set',
    price: '₹4,799',
    priceNum: 4799,
    boutique: 'Badshah Designer Fabrics',
    badge: 'Artisanal',
    ...
    additionalImages: ['https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?auto=format&fit=crop&w=600&q=80', 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&w=600&q=80'],
    shortDesc: 'Delicate hand-embroidered Chikankari suit on premium cotton. Light, breathable, and perfect for warm-weather festivities.',
    fabricDetails: 'Pure cotton base with authentic Lucknowi chikankari hand embroidery. Features shadow work, tepchi, and jaali stitches. Includes matching cotton dupatta.',
    fabricName: 'Pure Cotton',
    fabricDesc: 'Heritage Lucknowi handcraft on premium cotton.',
    rating: 4.8
  },
  {
    id: 'ms7',
    name: 'Heavy Velvet Bridal Suit Set',
    price: '₹12,999',
    priceNum: 12999,
    boutique: 'Badshah Designer Fabrics',
    ...
    sizes: ['S (36)', 'M (38)', 'L (40)', 'XL (42)', 'XXL (44)'],
    image: 'https://images.unsplash.com/photo-1610694955371-d4a3e0ce4b52?auto=format&fit=crop&w=600&q=80',
    additionalImages: ['https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&w=600&q=80', 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&w=600&q=80'],
    shortDesc: 'Majestic velvet Anarkali suit with heavy zardozi and danka embroidery. A showstopper for wedding receptions and sangeet ceremonies.',
    fabricDetails: 'Premium micro-velvet body with intricate hand-done zardozi, danka, and sequin embellishments. Includes heavy velvet dupatta with scalloped borders.',
    fabricName: 'Premium Micro-Velvet',
    fabricDesc: 'Royal warmth with exquisite hand embellishments.',
    rating: 4.9
  },
  {
    id: 'ms8',
    name: 'Casual Cotton Printed Suit',
    price: '₹2,499',
    priceNum: 2499,
    boutique: 'Badshah Designer Fabrics',
    badge: 'Daily Wear',
    ...
    sizes: ['M (38)', 'L (40)', 'XL (42)', 'XXL (44)'],
    image: 'https://images.unsplash.com/photo-1606800052052-a08af7148866?auto=format&fit=crop&w=600&q=80',
    additionalImages: ['https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?auto=format&fit=crop&w=600&q=80'],
    shortDesc: 'Comfortable daily-wear cotton suit with vibrant block prints. Perfect for everyday elegance at an affordable price.',
    fabricDetails: 'Soft premium cotton with traditional Punjabi block prints. Features comfortable straight pants and a matching cotton dupatta.',
    fabricName: 'Premium Cotton',
    fabricDesc: 'Breathable comfort with artisan block prints.',
    rating: 4.5
  },
  // ── Wedding Collection Products ──────────────────────────────
  {
    id: 'w1',
    name: 'Royal Maroon Bridal Anarkali',
    price: '₹14,999',
    priceNum: 14999,
    boutique: 'Royal Heritage',
    badge: 'Bridal Special',
    ...
    care: ['Dry Clean Only'],
    sizes: ['S (36)', 'M (38)', 'L (40)', 'XL (42)'],
    image: '/generated_red_suit.png',
    additionalImages: ['/hero_model_red.png'],
    shortDesc: 'Opulent maroon bridal anarkali with heavy zardozi and crystal embellishments.',
    fabricDetails: 'Premium maroon velvet with intricate gold zardozi, crystal, and danka handwork.',
    fabricName: 'Premium Velvet',
    fabricDesc: 'Royal bridal velvet with heavy embellishment.',
    rating: 5.0
  },
  {
    id: 'w2',
    name: 'Gold Brocade Wedding Sharara',
    price: '₹18,499',
    priceNum: 18499,
    boutique: 'Kashi Fabrics',
    badge: 'Grand Wedding',
    ...
    sizes: ['S (36)', 'M (38)', 'L (40)', 'XL (42)', 'XXL (44)'],
    image: '/suit1.png',
    additionalImages: ['/yellow_generated.png'],
    shortDesc: 'Luxurious gold Banarasi brocade sharara set for grand wedding celebrations.',
    fabricDetails: 'Pure Banarasi katan silk with gold zari brocade. Heavy handwoven sharara pants with matching dupatta.',
    fabricName: 'Banarasi Katan Silk',
    fabricDesc: 'Handwoven gold zari brocade.',
    rating: 5.0
  },
  {
    id: 'w3',
    name: 'Ivory Chikankari Bridal Suit',
    price: '₹12,999',
    priceNum: 12999,
    boutique: 'Awadh Kraft',
    badge: 'Artisanal',
    ...
    type: 'Chikankari',
    suitType: 'Chikankari',
    occasions: ['Wedding', 'Nikah'],
    care: ['Dry Clean Only'],
    sizes: ['S (36)', 'M (38)', 'L (40)', 'XL (42)'],
    image: '/generated_white_suit.png',
    additionalImages: ['/hero_model_ivory.png'],
    shortDesc: 'Elegant ivory chikankari bridal suit with珍珠 and mirror work accents.',
    fabricDetails: 'Pure georgette with authentic Lucknowi chikankari,珍珠 embellishments, and mirror work.',
    fabricName: 'Pure Georgette',
    fabricDesc: 'Chikankari with珍珠 accents.',
    rating: 4.9
  },
  {
    id: 'w4',
    name: 'Red Velvet Bridal Lehenga Suit',
    price: '₹22,999',
    priceNum: 22999,
    boutique: 'Rajputana',
    badge: 'Exclusive',
    ...
    care: ['Dry Clean Only'],
    sizes: ['S (36)', 'M (38)', 'L (40)', 'XL (42)'],
    image: '/model_maroon_suit.png',
    additionalImages: ['/hero_model_maroon.png'],
    shortDesc: 'Magnificent red velvet bridal lehenga suit with heavy zardozi and Swarovski crystals.',
    fabricDetails: 'Premium red velvet with hand-applied zardozi, Swarovski crystals, and danka work.',
    fabricName: 'Premium Velvet',
    fabricDesc: 'Bridal red with crystal embellishment.',
    rating: 5.0
  },
  {
    id: 'w5',
    name: 'Peach Organza Wedding Suit',
    price: '₹9,799',
    priceNum: 9799,
    boutique: 'Gulabo Jaipur',
    badge: 'Best Seller',
    ...
    additionalImages: ['/suit2.png'],
    shortDesc: 'Dreamy peach organza sharara suit with delicate thread embroidery and sequins.',
    fabricDetails: 'Pure organza silk with thread embroidery, sequins, and scalloped borders.',
    fabricName: 'Pure Organza Silk',
    fabricDesc: 'Lightweight with thread embroidery.',
    rating: 4.8
  },
  {
    id: 'w6',
    name: 'Wine Heavy Bridal Anarkali',
    price: '₹16,499',
    priceNum: 16499,
    boutique: 'Lakhnavi Shaan',
    badge: 'Festive Special',
    ...
    care: ['Dry Clean Only'],
    sizes: ['S (36)', 'M (38)', 'L (40)', 'XL (42)', 'XXL (44)'],
    image: '/wine_generated.png',
    additionalImages: ['/designer_suit_1.png'],
    shortDesc: 'Wine-colored heavy bridal anarkali with Lucknowi zardozi and mirror work.',
    fabricDetails: 'Wine silk with intricate Lucknowi zardozi, mirror work, and Resham thread details.',
    fabricName: 'Art Silk',
    fabricDesc: 'Heavy bridal zardozi work.',
    rating: 4.9
  },
  {
    id: 'w7',
    name: 'Mint Green Mehendi Suit',
    price: '₹7,499',
    priceNum: 7499,
    boutique: 'Zari Heritage',
    badge: 'Mehendi Special',
    collection: 'Wedding',
    type: 'Patiala',
    suitType: 'Patiala',
    occasions: ['Wedding', 'Mehendi'],
    care: ['Hand Wash'],
    sizes: ['M (38)', 'L (40)', 'XL (42)', 'XXL (44)'],
    image: '/bottle_green_generated.png',
    additionalImages: ['/anarkali_suit.png'],
    shortDesc: 'Fresh mint green Patiala suit perfect for mehendi ceremonies with gota patti work.',
    fabricDetails: 'Soft cotton silk with traditional gota patti and dori work borders.',
    fabricName: 'Cotton Silk',
    fabricDesc: 'Fresh mint with gota accents.',
    rating: 4.7
  },
  {
    id: 'w8',
    name: 'Blush Pink Reception Gown Suit',
    price: '₹11,999',
    priceNum: 11999,
    boutique: 'Punjabi Couture',
    badge: 'Premium',
    ...
    care: ['Dry Clean Only'],
    sizes: ['S (36)', 'M (38)', 'L (40)', 'XL (42)'],
    image: '/pink_anarkali_model.png',
    additionalImages: ['/chikankari_suit.png'],
    shortDesc: 'Elegant blush pink reception gown-style suit with French knot embroidery.',
    fabricDetails: 'Pure georgette with French knot embroidery, sequins, and scalloped hem.',
    fabricName: 'Pure Georgette',
    fabricDesc: 'Blush pink with French knots.',
    rating: 4.8
  },
  {
    id: 'w9',
    name: 'Maroon Pakistani Bridal Suit',
    price: '₹13,499',
    priceNum: 13499,
    boutique: 'Nazraana',
    badge: 'Bridal Special',
    ...
    sizes: ['S (36)', 'M (38)', 'L (40)', 'XL (42)'],
    image: '/model_maroon_suit.png',
    additionalImages: ['/banarasi_suit.png'],
    shortDesc: 'Maroon Pakistani-style straight cut bridal suit with heavy thread and stone work.',
    fabricDetails: 'Premium cotton silk with intricate thread work, stone embellishments, and organza dupatta.',
    fabricName: 'Cotton Silk',
    fabricDesc: 'Maroon with stone embellishment.',
    rating: 4.9
  },
  {
    id: 'w10',
    name: 'Gold & Black Wedding Sharara',
    price: '₹15,999',
    priceNum: 15999,
    boutique: 'Vastra',
    badge: 'Exclusive',
    ...
    care: ['Dry Clean Only'],
    sizes: ['S (36)', 'M (38)', 'L (40)', 'XL (42)'],
    image: '/black_generated.png',
    additionalImages: ['/black_edit.png'],
    shortDesc: 'Dramatic black and gold sharara set with heavy gold embroidery for evening weddings.',
    fabricDetails: 'Premium black velvet with heavy gold zardozi, sequins, and crystal work.',
    fabricName: 'Premium Velvet',
    fabricDesc: 'Black with gold zardozi.',
    rating: 5.0
  },
  {
    id: 'w11',
    name: 'Lavender Sangeet Anarkali',
    price: '₹8,999',
    priceNum: 8999,
    boutique: 'Shagun Jaipur',
    badge: 'Trending',
    ...
    care: ['Dry Clean Only'],
    sizes: ['S (36)', 'M (38)', 'L (40)', 'XL (42)', 'XXL (44)'],
    image: '/lavender_generated.png',
    additionalImages: ['/luxury_edit.png'],
    shortDesc: 'Lavender anarkali perfect for sangeet nights with mirror work and gota patti.',
    fabricDetails: 'Art silk with mirror work, gota patti borders, and Resham thread details.',
    fabricName: 'Art Silk',
    fabricDesc: 'Lavender with mirror work.',
    rating: 4.7
  },
  {
    id: 'w12',
    name: 'Cream Haldi Ceremony Suit',
    price: '₹5,499',
    priceNum: 5499,
    boutique: 'Jaipur Block',
    badge: 'Haldi Special',
    collection: 'Wedding',
    type: 'Patiala',
    suitType: 'Patiala',
    occasions: ['Wedding', 'Haldi'],
    care: ['Hand Wash'],
    sizes: ['M (38)', 'L (40)', 'XL (42)', 'XXL (44)'],
    image: '/yellow_generated.png',
    additionalImages: ['/cotton_suit.png'],
    shortDesc: 'Cream and yellow Patiala suit ideal for haldi ceremonies with block prints.',
    fabricDetails: 'Soft cotton with traditional block prints, yellow gota borders, and mirror work accents.',
    fabricName: 'Pure Cotton',
    fabricDesc: 'Cream with block prints.',
    rating: 4.6
  },
  // ── Dedicated Anarkali Collection ──────────────────────────
  {
    id: 'a1',
    name: 'Blush Pink Organza Anarkali',
    price: '₹12,499',
    priceNum: 12499,
    boutique: 'Anarkali Studio',
    badge: 'New Arrival',
    collection: 'Anarkali',
    type: 'Anarkali',
    suitType: 'Anarkali',
    ...
    image: '/pink_anarkali_model.png',
    additionalImages: ['/anarkali_suit.png'],
    shortDesc: 'Stunning blush pink organza anarkali with detailed thread work.',
    fabricDetails: 'Pure organza with intricate hand embroidery.',
    fabricName: 'Pure Organza',
    fabricDesc: 'Lightweight with a royal drape.',
    rating: 4.8
  },
  {
    id: 'a2',
    ...
    image: '/generated_red_suit.png',
    additionalImages: ['/hero_model_red.png'],
    shortDesc: 'Heavy maroon velvet anarkali with zardozi embroidery.',
    fabricDetails: 'Premium micro-velvet adorned with golden zardozi work.',
    fabricName: 'Premium Velvet',
    fabricDesc: 'Rich, luxurious feel.',
    rating: 5.0
  },
  {
    id: 'a3',
    name: 'Wine Georgette Anarkali',
    price: '₹9,499',
    priceNum: 9499,
    boutique: 'Royal Boutique',
    badge: 'Best Seller',
    collection: 'Anarkali',
    type: 'Anarkali',
    suitType: 'Anarkali',
    ...
    image: '/wine_generated.png',
    additionalImages: ['/designer_suit_1.png'],
    shortDesc: 'Deep wine anarkali suit with sparkling mirror work.',
    fabricDetails: 'Flowy georgette with lucknowi thread and mirror embellishments.',
    fabricName: 'Georgette',
    fabricDesc: 'Smooth and elegant.',
    rating: 4.7
  },
  {
    id: 'a4',
    ...
    price: '₹14,299',
    priceNum: 14299,
    boutique: 'Pastel Dreams',
    badge: 'Trending',
    collection: 'Anarkali',
    type: 'Anarkali',
    suitType: 'Anarkali',
    occasions: ['Festive', 'Sangeet'],
    care: ['Dry Clean Only'],
    sizes: ['S (36)', 'M (38)', 'L (40)', 'XL (42)'],
    image: '/lavender_generated.png',
    additionalImages: ['/pastel_edit.png'],
    shortDesc: 'Soft lavender silk anarkali with silver zari borders.',
    fabricDetails: 'Pure silk base with subtle silver zari weaving.',
    fabricName: 'Pure Silk',
    fabricDesc: 'Luxurious sheen.',
    rating: 4.9
  },
  {
    id: 'a5',
    name: 'Bottle Green Festive Anarkali',
    price: '₹11,999',
    priceNum: 11999,
    boutique: 'Emerald Couture',
    badge: 'Festive Special',
    collection: 'Anarkali',
    type: 'Anarkali',
    suitType: 'Anarkali',
    occasions: ['Mehendi', 'Party'],
    care: ['Dry Clean Only'],
    sizes: ['S (36)', 'M (38)', 'L (40)', 'XL (42)', 'XXL (44)'],
    image: '/bottle_green_generated.png',
    additionalImages: ['/anarkali_suit.png'],
    shortDesc: 'Vibrant bottle green anarkali with gota patti work.',
    fabricDetails: 'Rich cotton silk blend highlighted with traditional gota patti.',
    fabricName: 'Cotton Silk',
    fabricDesc: 'Comfortable with a festive shine.',
    rating: 4.6
  },
  {
    id: 'a6',
    ...
    image: '/generated_white_suit.png',
    additionalImages: ['/hero_model_ivory.png'],
    shortDesc: 'Pristine ivory anarkali completely covered in chikankari handwork.',
    fabricDetails: 'Pure georgette canvas with intricate Lucknowi shadow work.',
    fabricName: 'Pure Georgette',
    fabricDesc: 'Lightweight and sheer elegance.',
    rating: 5.0
  },
  {
    id: 'a7',
    name: 'Golden Yellow Haldi Anarkali',
    price: '₹7,999',
    priceNum: 7999,
    boutique: 'Sunshine Weaves',
    badge: 'Haldi Special',
    collection: 'Anarkali',
    type: 'Anarkali',
    suitType: 'Anarkali',
    occasions: ['Haldi', 'Festive'],
    care: ['Hand Wash'],
    sizes: ['M (38)', 'L (40)', 'XL (42)', 'XXL (44)'],
    image: '/yellow_generated.png',
    additionalImages: ['/cotton_suit.png'],
    shortDesc: 'Bright golden yellow anarkali suit for vibrant haldi ceremonies.',
    fabricDetails: 'Soft cotton base with contrast floral block prints and mirror borders.',
    fabricName: 'Pure Cotton',
    fabricDesc: 'Breathable and extremely comfortable.',
    rating: 4.5
  },
  {
    id: 'a8',
    name: 'Midnight Black Designer Anarkali',
    price: '₹15,499',
    priceNum: 15499,
    boutique: 'Noir Elegance',
    badge: 'Exclusive',
    collection: 'Anarkali',
    type: 'Anarkali',
    suitType: 'Anarkali',
    ...
    image: '/black_generated.png',
    additionalImages: ['/black_edit.png'],
    shortDesc: 'Dramatic midnight black anarkali with gold sequins.',
    fabricDetails: 'Premium georgette encrusted with heavy golden sequin work.',
    fabricName: 'Premium Georgette',
    fabricDesc: 'Flowy with dramatic flair.',
    rating: 4.9
  },
  {
    id: 'a9',
    name: 'Classic Maroon Silk Anarkali',
    price: '₹13,299',
    priceNum: 13299,
    boutique: 'Royal Heritage',
    badge: 'Classic',
    ...
    image: '/model_maroon_suit.png',
    additionalImages: ['/banarasi_suit.png'],
    shortDesc: 'Timeless maroon silk anarkali with minimal zari work.',
    fabricDetails: 'Pure art silk with delicate golden zari motifs and heavy borders.',
    fabricName: 'Art Silk',
    fabricDesc: 'Smooth texture and rich color.',
    rating: 4.8
  },
  {
    id: 'a10',
    name: 'Pastel Blue Net Anarkali',
    price: '₹10,999',
    priceNum: 10999,
    boutique: 'Pastel Dreams',
    badge: 'Trending',
    ...
    image: '/suit1.png',
    additionalImages: ['/suit2.png'],
    shortDesc: 'Dreamy pastel blue net anarkali with pearl embellishments.',
    fabricDetails: 'Soft premium net over satin lining, adorned with pearls and stones.',
    fabricName: 'Premium Net',
    fabricDesc: 'Ethereal and delicate.',
    rating: 4.7
  },
  {
    id: 'a11',
    name: 'Emerald Green Brocade Anarkali',
    price: '₹17,999',
    priceNum: 17999,
    boutique: 'Kashi Fabrics',
    badge: 'Premium',
    ...
    image: '/suit3.png',
    additionalImages: ['/designer_suit_1.png'],
    shortDesc: 'Heavy emerald green Banarasi brocade anarkali.',
    fabricDetails: 'Handwoven Banarasi brocade with intricate gold motifs.',
    fabricName: 'Banarasi Brocade',
    fabricDesc: 'Rich heritage weave.',
    rating: 5.0
  },
  {
    id: 'a12',
    name: 'Peach Floral Anarkali Suit',
    price: '₹8,499',
    priceNum: 8499,
    boutique: 'Spring Blossoms',
    badge: 'Summer Edit',
    collection: 'Anarkali',
    type: 'Anarkali',
    suitType: 'Anarkali',
    ...
    image: '/pastel_edit.png',
    additionalImages: ['/cotton_suit.png'],
    shortDesc: 'Lightweight peach anarkali with vibrant floral digital prints.',
    fabricDetails: 'Crepe silk featuring modern floral prints and minimal beadwork.',
    fabricName: 'Crepe Silk',
    fabricDesc: 'Soft, flowy, and wrinkle-resistant.',
    rating: 4.6
  }
];
...
export const staticBoutiques = {
  ...
  'Badshah Designer Fabrics': {
    name: 'Badshah Designer Fabrics',
    description: 'For over 15 years we\'ve been bringing handcrafted Punjabi fashion to thousands of happy customers. Founded in 2008 in the heart of Ludhiana, specializing in premium silk collections and traditional Punjabi embroidery.',
    contact: '+91 98765 43210 | hello@badshahdesignerfabrics.com',
