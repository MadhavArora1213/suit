  ...
  return (
    <section className="bg-[#FAF9F6] relative h-[100vh] md:h-[120vh] overflow-hidden" id="lookbook">
      ...
      <div className="absolute top-32 left-6 md:left-14 z-10 max-w-lg pointer-events-none">
        <span className="text-[11px] tracking-[0.5em] text-[#D4AF37] uppercase block mb-6 font-medium" style={{ fontFamily: "'DM Sans', sans-serif" }}>Interactive Editorial</span>
        <h2 className="text-6xl md:text-8xl font-light text-[#1A0008] leading-none mb-6 tracking-tight"
          style={{ fontFamily: "'Cormorant Garamond', serif" }}>
          Shop The <br/><em className="italic text-[#D4AF37] font-light">Campaign</em>
        </h2>
        <p className="text-[#555] text-[13px] leading-loose font-light" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            ...
            >
              ...
              <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-500 shadow-xl backdrop-blur-md border ${
                activeHotspot?.id === hotspot.id 
                  ? 'bg-white border-white text-[#1A0008] scale-110' 
                  : 'bg-white/40 border-white/50 text-[#1A0008] hover:bg-white hover:text-[#1A0008] hover:scale-110'
              }`}>
              ...
              <div className="absolute left-10 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none whitespace-nowrap bg-white/90 backdrop-blur-md border border-[#1A0008]/5 text-[#1A0008] text-[10px] uppercase tracking-[0.3em] font-medium px-4 py-2 shadow-lg" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                View Details
              </div>
            </button>
          </div>
      ...
      <AnimatePresence>
        {activeHotspot && (
          <motion.div 
            ...
            className="fixed md:absolute bottom-6 left-6 right-6 md:bottom-auto md:top-1/2 md:-translate-y-1/2 md:right-14 md:left-auto w-auto md:w-full md:max-w-[380px] bg-white/95 backdrop-blur-xl border border-[#1A0008]/5 shadow-2xl p-8 z-30"
          >
            <button 
              onClick={() => setActiveHotspot(null)}
              className="absolute top-6 right-6 text-[#1A0008]/40 hover:text-[#1A0008] transition-colors cursor-pointer z-40"
            >
            ...
            <div className="flex items-center gap-3 mb-4 text-[#D4AF37]">
              ...
              <span className="text-[10px] font-medium tracking-[0.3em] uppercase" style={{ fontFamily: "'DM Sans', sans-serif" }}>Spotted in Look 01</span>
            </div>
            ...
            <h3 
              ...
              className="text-3xl font-light text-[#1A0008] mb-2 hover:text-[#D4AF37] transition-colors cursor-pointer" 
              style={{ fontFamily: "'Cormorant Garamond', serif" }}
            >
              {activeHotspot.productName}
            </h3>
            <span className="text-[12px] tracking-[0.2em] font-medium text-[#1A0008] block mb-6" style={{ fontFamily: "'DM Sans', sans-serif" }}>{activeHotspot.price}</span>
            
            <p className="text-[13px] text-[#555] leading-loose mb-8 font-light" style={{ fontFamily: "'DM Sans', sans-serif" }}>
              {activeHotspot.desc}
            </p>
      ...
      const size = fit === 'Stitched' ? (found.sizes?.length > 0 ? `Stitched - ${found.sizes[0]}` : 'Stitched') : fit;
                ...
                className="w-full bg-[#1A0008] hover:bg-[#D4AF37] text-white py-4 text-[10px] font-medium tracking-[0.3em] uppercase flex items-center justify-center gap-3 transition-colors duration-500 cursor-pointer"
