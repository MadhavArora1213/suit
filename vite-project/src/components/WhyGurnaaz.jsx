...
export default function WhyGurnaaz() {
  return (
    <section className="py-24 md:py-32 bg-[#FAF9F6] overflow-hidden border-y border-[#1A0008]/10 relative">
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            <div className="w-8 h-px bg-[#1A0008]/20" />
            <span className="text-[#8B1A1A] text-[10px] tracking-[0.4em] uppercase font-bold" style={{ fontFamily: "'DM Sans', sans-serif" }}>Our Promise</span>
            <div className="w-8 h-px bg-[#1A0008]/20" />
          </motion.div>
          <h2 className="text-[40px] md:text-[60px] text-[#1A0008] font-light leading-tight tracking-tighter" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            Why <span className="italic text-[#8B1A1A]">Gurnaaz?</span>
          </h2>
        </div>
        ...
        <div className="relative w-full h-[1800px] md:h-[900px] flex flex-col md:flex-row gap-4 md:gap-6">
          ...
          <div className="flex-1 flex flex-col gap-4 md:gap-6 h-full">
            ...
            >
              <div className="relative z-20">
                ...
                <h3 className="text-3xl text-[#1A0008] font-light leading-tight mb-4" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Authentic<br/>Punjabi Craft</h3>
                <p className="text-[#1A0008]/60 text-sm font-light leading-relaxed">Rooted in the heart of Punjab. Every suit is a celebration of our vibrant culture, crafted with traditional techniques passed down through generations.</p>
              </div>
            </motion.div>
            ...
            >
              <div className="relative z-10">
                ...
                <h3 className="text-3xl text-[#1A0008] font-light leading-tight mb-2" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Premium Fabrics</h3>
                <p className="text-[#1A0008]/80 text-sm font-light leading-relaxed">We use only the finest cottons, pure georgettes, and rich silks so your suit feels as luxurious as it looks.</p>
              </div>
            </motion.div>
            ...
            >
               <div className="relative z-10">
                  ...
                  <h3 className="text-xl text-[#1A0008] font-light leading-tight mb-1" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Flawless Tailoring</h3>
                  <p className="text-[#1A0008]/60 text-xs font-light">No loose threads. No uneven seams. Just immaculate stitching.</p>
               </div>
            </motion.div>
            ...
            <div className="h-[500px] md:h-[60%] flex flex-col md:flex-row gap-4 md:gap-6">
              ...
              >
                <div className="relative z-10">
                  ...
                  <p className="text-white/90 text-sm font-light leading-relaxed">From Punjab to the world. We deliver your favorite ethnic wear securely to your doorstep, fully insured, anywhere across the globe.</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative z-10 pl-12 md:pl-20 mt-auto">
                  ...
                  <p className="text-[#1A0008]/60 text-sm font-light leading-relaxed mb-6">A premium experience. Your suit arrives in beautiful, bespoke packaging—perfect for gifting.</p>
                </div>
                
                {/* Brand Logos (Mockup) */}
                <div className="flex gap-6 items-center opacity-40 mix-blend-multiply relative z-10 text-[#1A0008]">
          ...
          <div className="flex-1 flex flex-col gap-4 md:gap-6 h-full">
            ...
            >
              ...
              <div className="absolute bottom-8 left-8 right-8">
                ...
                <h3 className="text-2xl text-[#1A0008] font-light leading-tight mb-2" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Modern Yet<br/>Traditional</h3>
                <p className="text-[#1A0008]/60 text-xs font-light">Classic Punjabi silhouettes updated with contemporary cuts.</p>
              </div>
            </motion.div>
            ...
            >
              <div className="relative z-10">
                ...
                <h3 className="text-2xl text-[#1A0008] font-light leading-tight mb-2" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Ethical Craft</h3>
                <p className="text-[#1A0008]/60 text-sm font-light leading-relaxed">We directly support local artisans and karigars in Punjab, ensuring fair wages.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-[#1A0008]/60 text-xs font-light">Skip the tailor. Pre-stitched and ready to flaunt.</p>
            </motion.div>
          ...
          >
            ...
            <div className="relative z-10 bg-white/80 backdrop-blur-md px-8 py-4 rounded-full border border-[#1A0008]/10 shadow-sm">
              <h3 className="text-2xl text-[#1A0008] font-light text-center leading-none" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                The<br/>Experience
              </h3>
            </div>
          </motion.div>
